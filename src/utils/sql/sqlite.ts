import type { ResultRow } from '@decafcode/sqlite'
import Database from '@decafcode/sqlite'
import { randomBytes } from 'crypto'
import type * as sql from 'sql-bricks-postgres'

import type { DataSource, Row, Transaction } from './api'
import type { Id } from '../model'

// bless me father for i have sinned
const fuFixup = / FOR UPDATE$/
  ...
  async maintenance<T>(
    ...
    try {
      ...
      if (fkViolations.length > 0) {
        console.log('Foreign key violations: %O', fkViolations)
